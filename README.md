...
A Cosmology Group maintains this website in a github [repository](https://github.com/a-cosmology-group/acg/), including the [ACG Newsletter](newsletters/README.md). Observational data and work of interest to ACG are listed in [Resources](resources/README.md). To contribute to the content, please consult the project [wiki](https://github.com/a-cosmology-group/acg/wiki).
